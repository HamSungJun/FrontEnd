...
let SungJun = new Person('성준','170');

console.log(SungJun.personInfo());
console.log(SungJun.add(10,5));
console.log(SungJun.sub(10,5));

let James = new upgradedPerson('제임스','188');
